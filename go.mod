...
require (
	github.com/aliyun/alibaba-cloud-sdk-go v1.61.1760 // indirect
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dnspod v1.0.488 // indirect
